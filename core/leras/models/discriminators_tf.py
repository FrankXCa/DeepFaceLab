...
This file contains the official TensorFlow discriminator implementations that
Phase 3F replaced in place with the torch versions:

    CodeDiscriminator.py  (official: 22 lines)  -> core/leras/models/CodeDiscriminator.py (torch)
    PatchDiscriminator.py (official: 194 lines) -> core/leras/models/PatchDiscriminator.py (torch:
                                             PatchDiscriminator + UNetPatchDiscriminator +
                                             the patch_discriminator_kernels table)
...
preserve the constructor signatures, layer tables (kernels/strides/channel
progressions), the UNet find_archi/calc_receptive_field_size logic, the
activation alphas, and the official checkpoint naming (see
core.leras.checkpoint).
"""

# ===========================================================================
# OFFICIAL (TF) CodeDiscriminator.py
# ===========================================================================
...
# ===========================================================================
# OFFICIAL (TF) PatchDiscriminator.py
# ===========================================================================
